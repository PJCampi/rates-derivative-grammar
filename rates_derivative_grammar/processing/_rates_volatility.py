...
class CapFloorProcessor(SingleSizeProcessorMixin,
                        RelativeStrikeProcessorMixin,
                        RatesVolatilityProcessor):
    product_type = 'cap_floor'
    attribute_names = ('currency', 'start_time', 'end_time', 'is_relative',
                       'strike', 'contract_type', 'float_freq', 'size')


class CapFloorStrategyProcessor(SingleSizeProcessorMixin,
                                RelativeStrikeProcessorMixin,
                                RatesVolatilityProcessor):
    product_type = 'cap_floor_strategy'
    attribute_names = ('currency', 'start_time', 'end_time', 'is_relative',
                       'strike', 'width', 'contract_type', 'float_freq', 'size')


class SwaptionProcessor(SingleSizeProcessorMixin,
                        RelativeStrikeProcessorMixin,
                        RatesVolatilityProcessor):
    product_type = 'swaption'
    attribute_names = ('currency', 'start_time', 'end_time', 'is_relative',
                       'strike', 'contract_type', 'float_freq', 'settlement_method', 'size')


class SwaptionStrategyProcessor(SingleSizeProcessorMixin,
                                RelativeStrikeProcessorMixin,
                                RatesVolatilityProcessor):
    product_type = 'swaption_strategy'
    attribute_names = ('currency', 'start_time', 'end_time', 'is_relative',
                       'strike', 'width', 'contract_type', 'float_freq', 'settlement_method', 'size')
