...
class TestLinearRateGrammar:
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ...
                                 ('7Y5Y -100mm', {'start_time': '7Y', 'end_time': '5Y', 'size': -100_000_000}),
                                 ('1sep2715sep37 2 b6s', {'start_time': date(2027, 9, 1), 'end_time': date(2037, 9, 15), 'strike': 0.02, 'float_freq': '6M'}),
                                 ('15sep3725Y 2 2', {'start_time': date(2037, 9, 15), 'end_time': '25Y', 'strike': 0.02, 'size': 2}),
                                 ('7Y 0.4 b6s 1bn', {'end_time': '7Y', 'strike': 0.004, 'float_freq': '6M', 'size': 1_000_000_000}),
                                 ('10Y10Y b6s', {'start_time': '10Y', 'end_time': '10Y', 'float_freq': '6M'}),
                                 ('M8U8 b1d 100mm', {'start_time': 'M8', 'end_time': 'U8', 'float_freq': '1D', 'size': 100_000_000}),
                                 ('EUR 4.25Y b3s 100mm', {'currency': Currency.EUR, 'end_time': '4.25Y', 'float_freq': '3M', 'size': 100_000_000}),
                                 ('EUR 10Y 97.25kr', {'currency': Currency.EUR, 'end_time': '10Y', 'size': 97_250, 'is_risk': True}),
                                 ('EUR 1Y23M b1d 100mm', {'currency': Currency.EUR, 'start_time': '1Y', 'end_time': '23M', 'float_freq': '1D', 'size': 100_000_000}),
                                 ('EUR 1W 1 b1d', {'currency': Currency.EUR, 'end_time': '1W', 'strike': 0.01, 'float_freq': '1D'}),
                                 ('EUR 0D b1d', {'currency': Currency.EUR, 'end_time': '0D', 'float_freq': '1D'}),
                                 ('EUR 1D b1d', {'currency': Currency.EUR, 'end_time': '1D', 'float_freq': '1D'}),
                                 ('EUR 5Y10Y 0.1 B1S ACT365 100KR', {'currency': Currency.EUR, 'start_time': '5Y', 'end_time': '10Y', 'strike': 0.001, 'float_freq': '1M', 'fixed_daycount': DayCount.ACT365, 'size': 100_000, 'is_risk': True}),
                                 ('10y', {'end_time': '10Y'}),
                                 ...
                                 ('4apr1910y 100mm', {'start_time': date(2019, 4, 4), 'end_time': '10Y', 'size': 100_000_000}),
                                 ('10y -10kr',  {'end_time': '10Y', 'size': -10_000, 'is_risk': True}),
                                 ('EUR 5Y5Y b3s -50.1kr', {'currency': Currency.EUR, 'start_time': '5Y', 'end_time': '5Y', 'float_freq': '3M', 'size': -50_100, 'is_risk': True}),
                                 ('10y b6s', {'end_time': '10Y', 'float_freq': '6M'}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('3x6 100mm', {'start_time': '3M', 'end_time': '6M', 'size': 100_000_000}),
                                 ('3x6i -100mm', {'start_time': '3M', 'end_time': '6M', 'is_imm': True, 'size': -100_000_000}),
                                 ...
                                 ('DKK 11x23 0.12 125.1mm', {'currency': Currency.DKK, 'start_time': '11M', 'end_time': '23M', 'strike': 0.0012, 'size': 125_100_000}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('10Y 2 b3s6s', {'end_time': '10Y', 'strike': 0.0002, 'float_freq': ['3M', '6M']}),
                                 ('EUR 5Y10Y 2/1 b1d6s ACT365 100KR', {'currency': Currency.EUR, 'start_time': '5Y', 'end_time': '10Y', 'strike': [0.02, 0.0001], 'float_freq': ['1D', '6M'], 'fixed_daycount': DayCount.ACT365, 'size': 100_000, 'is_risk': True}),
                                 ('10Y b1d3s', {'end_time': '10Y', 'float_freq': ['1D', '3M']}),
                                 ('sek 10Y b1d3s', {'currency': Currency.SEK, 'end_time': '10Y', 'float_freq': ['1D', '3M']}),
                                 ('10Y 8.5 b3s6s', {'end_time': '10Y', 'strike': 0.00085, 'float_freq': ['3M', '6M']}),
                                 ('2y10y 1.095/8.5 b3s6s', {'start_time': '2Y', 'end_time': '10Y', 'strike': [0.01095, 0.00085], 'float_freq': ['3M', '6M']}),
                                 ('10Y b3s6s 100mm', {'end_time': '10Y', 'float_freq': ['3M', '6M'], 'size': 100_000_000}),
                                 ('5y10y b3s6s 100mm', {'start_time': '5Y', 'end_time': '10Y', 'float_freq': ['3M', '6M'], 'size': 100_000_000}),
                                 ('10y b3s6s 10kr', {'end_time': '10Y', 'float_freq': ['3M', '6M'], 'size': 10_000, 'is_risk': True}),
                             ])
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ...
                                 ('dkksek mtm 5y10y -100mm', {'currencies': [Currency.DKK, Currency.SEK], 'is_mtm': True, 'start_time': '5Y', 'end_time': '10Y', 'size': -100_000_000}),
                             ])
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ...
                                 ('EUR 5Y 5s10s 2/1 b6s ACT365 1MM/500KR', {'currency': Currency.EUR, 'start_time': '5Y', 'end_time': ['5Y', '10Y'], 'strike': [0.02, 0.0001], 'float_freq': '6M', 'fixed_daycount': DayCount.ACT365, 'size': [1_000_000, 500_000], 'is_risk': True}),
                                 ('5s10s',  {'end_time': ['5Y', '10Y']}),
                                 ('3oct18 3s7s',  {'start_time': date(2018, 10, 3), 'end_time': ['3Y', '7Y']}),
                                 ('5s10s 100mm', {'end_time': ['5Y', '10Y'], 'size': 100_000_000}),
                                 ('sek 5s10s -100mm', {'currency': Currency.SEK, 'end_time': ['5Y', '10Y'], 'size': -100_000_000}),
                                 ('5s10s -193.4mm/100mm', {'end_time': ['5Y', '10Y'], 'size': [-193_400_000, 100_000_000]}),
                                 ('5s10s 61.5 b3s', {'end_time': ['5Y', '10Y'], 'strike': 0.00615, 'float_freq': '3M'}),
                                 ('5s10s b3s',  {'end_time': ['5Y', '10Y'], 'float_freq': '3M'}),
                                 ('5s10s 0.426/61.5 b3s',  {'end_time': ['5Y', '10Y'], 'strike': [0.00426, 0.00615], 'float_freq': '3M'}),
                             ])
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ...
                                 ('EUR 1jan195Ys30mar1910Ys 0.5/2 b1d ACT365 1.2MM', {'currency': Currency.EUR, 'start_time': [date(2019, 1, 1), date(2019, 3, 30)], 'end_time': ['5Y', '10Y'], 'strike': [0.005, 0.0002], 'float_freq': '1D', 'fixed_daycount': DayCount.ACT365, 'size': 1_200_000}),
                                 ('2y2ys4y2ys', {'start_time': ['2Y', '4Y'], 'end_time': ['2Y', '2Y']}),
                                 ('dkk 2y2ys4y2ys', {'currency': Currency.DKK, 'start_time': ['2Y', '4Y'], 'end_time': ['2Y', '2Y']}),
                                 ('2y2ys4y2ys b3s', {'start_time': ['2Y', '4Y'], 'end_time': ['2Y', '2Y'], 'float_freq': '3M'}),
                                 ('2y2ys4y2ys 0.426/61.5', {'start_time': ['2Y', '4Y'], 'end_time': ['2Y', '2Y'], 'strike': [0.00426, 0.00615]}),
                                 ('H02ysH22ys', {'start_time': ['H0', 'H2'], 'end_time': ['2Y', '2Y']}),
                                 ('H02ysH22ys 100mm', {'start_time': ['H0', 'H2'], 'end_time': ['2Y', '2Y'], 'size': 100_000_000}),
                                 ('H02ysH22ys b3s 100mm/100mmr', {'start_time': ['H0', 'H2'], 'end_time': ['2Y', '2Y'], 'float_freq': '3M', 'size': [100_000_000, 100_000_000], 'is_risk': True}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('5s7s10s b6s 100mm', {'end_time': ['5Y', '7Y', '10Y'], 'float_freq': '6M', 'size': 100_000_000}),
                                 ('EUR 1jan19 5s7s10s 0.5/2/1 b1d ACT365 -5K/10.2K/-5KR', {'currency': Currency.EUR, 'start_time': date(2019, 1, 1), 'end_time': ['5Y', '7Y', '10Y'], 'strike': [0.005, 0.0002, 0.01], 'float_freq': '1D', 'fixed_daycount': DayCount.ACT365, 'is_risk': True, 'size': [-5_000, 10_200, -5_000]}),
                                 ('5s7s10s', {'end_time': ['5Y', '7Y', '10Y']}),
                                 ('5oct18 5s7s10s', {'start_time': date(2018, 10, 5), 'end_time': ['5Y', '7Y', '10Y']}),
                                 ('5s7s10s 100mm', {'end_time': ['5Y', '7Y', '10Y'], 'size': 100_000_000}),
                                 ('5s7s10s -10kr', {'end_time': ['5Y', '7Y', '10Y'], 'size': -10_000, 'is_risk': True}),
                                 ('5s7s10s -1.99 b3s 100mm', {'end_time': ['5Y', '7Y', '10Y'], 'strike': -0.000199, 'float_freq': '3M', 'size': 100_000_000}),
                                 ('5s7s10s b3s -69mm/100mm/-35.9mm', {'end_time': ['5Y', '7Y', '10Y'], 'float_freq': '3M', 'size': [-69_000_000, 100_000_000, -35_900_000]}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('3y1ys4y1ys5y1ys 100mm', {'start_time': ['3Y', '4Y', '5Y'], 'end_time': ['1Y', '1Y', '1Y'], 'size': 100_000_000}),
                                 ...
                                 ('5y2ys7y2ys10y2ys b6s', {'start_time': ['5Y', '7Y', '10Y'], 'end_time': ['2Y', '2Y', '2Y'], 'float_freq': '6M'}),
                                 ('5y2ys7y2ys10y2ys -100mm', {'start_time': ['5Y', '7Y', '10Y'], 'end_time': ['2Y', '2Y', '2Y'], 'size': -100_000_000}),
                                 ('5y2ys7y2ys10y2ys -69mm/100mm/-35.9mm', {'start_time': ['5Y', '7Y', '10Y'], 'end_time': ['2Y', '2Y', '2Y'], 'size': [-69_000_000, 100_000_000, -35_900_000]}),
...
class TestRatesVolatilityGrammar:
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('10Y10Y P Cash 100mm', {'start_time': '10Y', 'end_time': '10Y', 'contract_type': SwaptionStrategy.PAYER, 'settlement_method': SettlementMethod.CASH_SETTLED_ISDA, 'size': 100_000_000}),
                                 ('Z910Y 1.35393 R Cash -100mm', {'start_time': 'Z9', 'end_time': '10Y', 'strike': 0.0135393, 'contract_type': SwaptionStrategy.RECEIVER, 'settlement_method': SettlementMethod.CASH_SETTLED_ISDA, 'size': -100_000_000}),
                                 ...
                                 ('10Y10Y p b6s', {'start_time': '10Y', 'end_time': '10Y', 'contract_type': SwaptionStrategy.PAYER, 'float_freq': '6M'}),
                                 ...
                                 ('EUR 10Y10Y p b3s Phys 100mm', {'currency': Currency.EUR, 'start_time': '10Y', 'end_time': '10Y', 'contract_type': SwaptionStrategy.PAYER, 'float_freq': '3M', 'settlement_method': SettlementMethod.PHYSICALLY_SETTLED, 'size': 100_000_000}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('5Y5Y 100WC 100mm', {'start_time': '5Y', 'end_time': '5Y', 'width': 0.01, 'contract_type': SwaptionStrategy.COLLAR, 'size': 100_000_000}),
                                 ('usd 5Y5Y 100WC -100mm', {'currency': Currency.USD, 'start_time': '5Y', 'end_time': '5Y', 'width': 0.01, 'contract_type': SwaptionStrategy.COLLAR, 'size': -100_000_000}),
                                 ('2y5y 10ws', {'start_time': '2Y', 'end_time': '5Y', 'width': 0.001, 'contract_type': SwaptionStrategy.STRANGLE}),
                                 ('5Y5Y 0WC 100mm', {'start_time': '5Y', 'end_time': '5Y', 'width': 0, 'contract_type': SwaptionStrategy.COLLAR, 'size': 100_000_000}),
                                 ...
                                 ('5Y5Y 50WS b3s', {'start_time': '5Y', 'end_time': '5Y', 'width': 0.005, 'contract_type': SwaptionStrategy.STRANGLE, 'float_freq': '3M'}),
                                 ...
                                 ('2y2y 100ws Phys -10mm', {'start_time': '2Y', 'end_time': '2Y', 'width': 0.01, 'contract_type': SwaptionStrategy.STRANGLE, 'settlement_method': SettlementMethod.PHYSICALLY_SETTLED, 'size': -10_000_000}),
                             ])
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ('7Yx12Y C b3s', {'start_time': '7Y', 'end_time': '12Y', 'contract_type': CapFloorStrategy.CAP, 'float_freq': '3M'}),
                                 ('6Mx10Y 0.91 F b6s -100mm', {'start_time': '6M', 'end_time': '10Y', 'strike': 0.0091, 'contract_type': CapFloorStrategy.FLOOR, 'float_freq': '6M', 'size': -100_000_000}),
                                 ('EUR 3Mx12M C b6s', {'currency': Currency.EUR, 'start_time': '3M', 'end_time': '12M', 'contract_type': CapFloorStrategy.CAP, 'float_freq': '6M'}),
                                 ('3Mx12M C b3s', {'start_time': '3M', 'end_time': '12M', 'contract_type': CapFloorStrategy.CAP, 'float_freq': '3M'}),
                                 ('usd 3Mx12M C', {'currency': Currency.USD, 'start_time': '3M', 'end_time': '12M', 'contract_type': CapFloorStrategy.CAP}),
                                 ('10Y F b6s 100mm', {'end_time': '10Y', 'contract_type': CapFloorStrategy.FLOOR, 'float_freq': '6M', 'size': 100_000_000}),
                                 ('10Y F b3s -10k', {'end_time': '10Y', 'contract_type': CapFloorStrategy.FLOOR, 'float_freq': '3M', 'size': -10_000}),
                                 ('10Y F', {'end_time': '10Y', 'contract_type': CapFloorStrategy.FLOOR}),
                                 ('EUR 0Mx10Y F b6s 100mm', {'currency': Currency.EUR, 'start_time': '0M', 'end_time': '10Y', 'contract_type': CapFloorStrategy.FLOOR, 'float_freq': '6M', 'size': 100_000_000}),
    ...
    @pytest.mark.parametrize('to_parse, values',
                             [
                                 ...
                                 ('EUR 3Mx12M 100WC b6s', {'currency': Currency.EUR, 'start_time': '3M', 'end_time': '12M', 'width': 0.01, 'contract_type': CapFloorStrategy.COLLAR, 'float_freq': '6M'}),
                                 ('3Mx12M 50WC b3s', {'start_time': '3M', 'end_time': '12M', 'width': 0.005, 'contract_type': CapFloorStrategy.COLLAR, 'float_freq': '3M'}),
                                 ('10Y 50WS b6s 100mm',  {'end_time': '10Y', 'width': 0.005, 'contract_type': CapFloorStrategy.STRANGLE, 'float_freq': '6M', 'size': 100_000_000}),
                                 ('10Y 100WC b3s -10k',  {'end_time': '10Y', 'width': 0.01, 'contract_type': CapFloorStrategy.COLLAR, 'float_freq': '3M', 'size': -10_000}),
                                 ('EUR 0Mx10Y 0WS b6s 100mm', {'currency': Currency.EUR, 'start_time': '0M', 'end_time': '10Y', 'width': 0.0, 'contract_type': CapFloorStrategy.STRANGLE, 'float_freq': '6M', 'size': 100_000_000}),
